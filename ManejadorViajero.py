...
class ManejadorViajero:
    ...
    def buscarViajeroPorNumero(self,numero):
        ...
        if bandera:
            ...
            resultado=i
        return resultado
    def consultarMillas(self,numeroViajero):
        print('Millas: ',self.__listaViajeros[self.buscarViajeroPorNumero(numeroViajero)].cantidadTotaldeMillas())
    def acumularMillas(self,numeroViajero,millasNuevas):
        if millasNuevas<0:
            print('No se admiten valores negativos')
        else:
            print('Millas actuales: ',self.__listaViajeros[self.buscarViajeroPorNumero(numeroViajero)].acumularMillas(millasNuevas))
    def canjearMillas(self,numeroViajero,millasACanjear):
        if millasACanjear<0:
            print('No se admiten valores negativos')
        else:
            print('Millas actuales: ',self.__listaViajeros[self.buscarViajeroPorNumero(numeroViajero)].canjearMillas(millasACanjear))
    def test(self):
        ...
        print(manejador.buscarViajeroPorNumero(19))
        print('Metodo consultarMillas()')
        manejador.consultarMillas(19)
        print('Metodo acumularMillas()')
        manejador.acumularMillas(19,1000)
        manejador.acumularMillas(19,-1000)
        print('Metodo canjearMillas()')
        manejador.canjearMillas(19,2001)
        manejador.canjearMillas(19,2000)
        manejador.canjearMillas(19,-1000)
